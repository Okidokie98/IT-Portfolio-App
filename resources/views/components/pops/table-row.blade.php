<tr class="justify-center">
    ...
    <td> <a href="{{ route('pops.show', $pop) }}" class="inline-block m-2 p-2 text-white bg-blue-500 hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-md">Edit</a></td>
</tr>
