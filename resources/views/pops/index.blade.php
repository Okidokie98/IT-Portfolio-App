                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <select id="sort" name="sort" class="form-control">
                            ...
                            <option value="series" {{ request('sort') == 'series' ? 'selected' : '' }}>
                                Series
                            </option>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select id="direction" name="direction" class="form-control">
                            <option value="asc" {{ request('direction') == 'asc' ? 'selected' : '' }}>Oplopend (A-Z)
                            </option>
                            <option value="desc" {{ request('direction') == 'desc' ? 'selected' : '' }}>Aflopend (Z-A)
                            </option>
                        </select>
                    </div>
                </div>
